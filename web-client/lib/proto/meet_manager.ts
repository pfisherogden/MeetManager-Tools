...
export const DatasetRequest: MessageFns<DatasetRequest> = {
  ...
  create<I extends Exact<DeepPartial<DatasetRequest>, I>>(base?: I): DatasetRequest {
    return DatasetRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DatasetRequest>, I>>(object: I): DatasetRequest {
    const message = createBaseDatasetRequest();
    message.filename = object.filename ?? "";
    return message;
  },
...
export const Relay: MessageFns<Relay> = {
  ...
  fromPartial<I extends Exact<DeepPartial<Relay>, I>>(object: I): Relay {
    ...
    message.relayLetter = object.relayLetter ?? "";
...
export const RelayList: MessageFns<RelayList> = {
  ...
  create<I extends Exact<DeepPartial<RelayList>, I>>(base?: I): RelayList {
    return RelayList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RelayList>, I>>(object: I): RelayList {
    const message = createBaseRelayList();
...
export const ScoreList: MessageFns<ScoreList> = {
  ...
  create<I extends Exact<DeepPartial<ScoreList>, I>>(base?: I): ScoreList {
    return ScoreList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ScoreList>, I>>(object: I): ScoreList {
    const message = createBaseScoreList();
...
export const EventScore: MessageFns<EventScore> = {
  ...
  create<I extends Exact<DeepPartial<EventScore>, I>>(base?: I): EventScore {
    return EventScore.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventScore>, I>>(object: I): EventScore {
    const message = createBaseEventScore();
    message.eventId = object.eventId ?? 0;
    message.eventName = object.eventName ?? "";
...
export const EventScoreList: MessageFns<EventScoreList> = {
  ...
  create<I extends Exact<DeepPartial<EventScoreList>, I>>(base?: I): EventScoreList {
    return EventScoreList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EventScoreList>, I>>(object: I): EventScoreList {
    const message = createBaseEventScoreList();
    message.eventScores = object.eventScores?.map((e) => EventScore.fromPartial(e)) || [];
    return message;
  },
};
...
export const GenerateReportRequest: MessageFns<GenerateReportRequest> = {
  ...
  fromPartial<I extends Exact<DeepPartial<GenerateReportRequest>, I>>(object: I): GenerateReportRequest {
    ...
    message.teamFilter = object.teamFilter ?? "";
    return message;
  },
};
...
export interface MeetManagerServiceImplementation<CallContextExt = {}> {
  ...
  clearDataset(request: DatasetRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  clearAllDatasets(request: Empty, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** New Data Operations */
  ...
  getEventScores(request: Empty, context: CallContext & CallContextExt): Promise<DeepPartial<EventScoreList>>;
  generateReport(
    request: GenerateReportRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ReportResponse>>;
}
...
export interface MeetManagerServiceClient<CallOptionsExt = {}> {
  ...
  clearDataset(request: DeepPartial<DatasetRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  clearAllDatasets(request: DeepPartial<Empty>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** New Data Operations */
  ...
  getEventScores(request: DeepPartial<Empty>, options?: CallOptions & CallOptionsExt): Promise<EventScoreList>;
  generateReport(
    request: DeepPartial<GenerateReportRequest>,
    options?: CallOptions & CallOptionsExt,
