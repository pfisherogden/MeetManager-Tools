...
test.describe('Dashboard Smoke Test', () => {
  test('should load the dashboard with stats', async ({ page }) => {
    ...
    if (!isMobile) {
      ...
      await expect(page.locator('[data-slot="sidebar-header"]').getByText('SwimMeet Pro')).toBeVisible();
  ...
  test('should navigate to Meets page', async ({ page }) => {
    ...
    await page.locator('[data-sidebar="sidebar"]').getByRole('link', { name: 'Meets', exact: true }).click();
