...
import type { Score, EventScore } from "@/lib/swim-meet-types";
...
describe("ScoresManager", () => {
    it("renders team scores by default", () => {
        render(<ScoresManager initialScores={mockScores} initialEventScores={mockEventScores} />);
    ...
    it("renders event results when the tab is active by default", () => {
        ...
        expect(screen.queryByText("Alice Blue", { selector: 'span' })).toBeDefined();
    });
});
