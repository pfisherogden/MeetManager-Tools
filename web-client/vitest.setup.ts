...
global.fetch = vi.fn(() => Promise.reject(new Error("Network request blocked in unit tests")));
...
const mockActions = {
	...
	validateActiveMeet: vi.fn(() => Promise.resolve({ success: true, findings: [] })),
	...
	getAdminConfig: vi.fn(() => Promise.resolve({ meetName: "Test Meet", meetDescription: "" })),
	getGoogleConfig: vi.fn(() => Promise.resolve({ apiKey: "", clientId: "", appId: "" })),
	...
	generateReportBundle: vi.fn(() => Promise.resolve({ success: true, jobId: "123" })),
	getJobStatus: vi.fn(() => Promise.resolve({ status: "COMPLETED", progress: 100 })),
	getDashboardStats: vi.fn(() => Promise.resolve({ meetCount: 0, teamCount: 0, athleteCount: 0, eventCount: 0 })),
};
