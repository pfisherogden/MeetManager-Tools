            ...
            <main className="flex-1 flex flex-col min-h-screen bg-background">
                <div className="p-4 border-b flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/athletes" className="text-muted-foreground hover:text-foreground flex items-center gap-1">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-1 text-muted-foreground">
                                <Link href={`/teams/${athlete.teamId}`} className="hover:underline text-primary">
                                    {athlete.teamName}
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
                            ...
                            <dl className="space-y-4">
                                ...
                                <div className="flex justify-between border-b pb-2 last:border-0 last:pb-0">
                                    <dt className="text-muted-foreground font-medium">School Year</dt>
                                    <dd>{athlete.schoolYear || '-'}</dd>
                                </div>
                                <div className="flex justify-between border-b pb-2 last:border-0 last:pb-0">
                                    <dt className="text-muted-foreground font-medium">Registration No.</dt>
                                    <dd className="font-mono text-sm uppercase">{athlete.regNo || '-'}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
