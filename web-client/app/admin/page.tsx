...
export default function AdminPage() {
    const { meetName: initialMeetName, meetDescription: initialMeetDesc } = useConfig();
        ...
        <div className="flex min-h-screen bg-background">
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                <div className="p-6 pb-0">
                    ...
                    <p className="text-muted-foreground">Manage global settings for the meet</p>
                </div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <form onSubmit={handleSave} className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="meetDesc">Meet Description (Sidebar Footer)</Label>
                                    <Textarea
                                        id="meetDesc"
