            ...
            <main className="flex-1 flex flex-col min-h-screen bg-background">
                <div className="p-4 border-b flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/teams" className="text-muted-foreground hover:text-foreground flex items-center gap-1">
                        ...
                        <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
                            ...
                            <dl className="space-y-4">
                                <div className="flex justify-between border-b pb-2 last:border-0 last:pb-0">
                                    ...
                                    <dd className="font-mono bg-muted px-2 py-0.5 rounded text-sm">{team.code}</dd>
                                </div>
                                <div className="flex justify-between border-b pb-2 last:border-0 last:pb-0">
                                ...
                                <div className="flex justify-between border-b pb-2 last:border-0 last:pb-0">
                                    <dt className="text-muted-foreground font-medium">Athlete Count</dt>
