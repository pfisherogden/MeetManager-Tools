...
class Relay(_message.Message):
    __slots__ = ("id", "event_id", "team_id", "team_name", "leg1_name", "leg2_name", "leg3_name", "leg4_name", "seed_time", "final_time", "place", "event_name", "relay_letter", "heat", "lane", "team_color", "status")
    ID_FIELD_NUMBER: _ClassVar[int]
    EVENT_ID_FIELD_NUMBER: _ClassVar[int]
    TEAM_ID_FIELD_NUMBER: _ClassVar[int]
...
class Entry(_message.Message):
    __slots__ = ("id", "event_id", "athlete_id", "athlete_name", "team_id", "team_name", "seed_time", "final_time", "place", "event_name", "heat", "lane", "points", "team_color", "status")
    ID_FIELD_NUMBER: _ClassVar[int]
    EVENT_ID_FIELD_NUMBER: _ClassVar[int]
    ATHLETE_ID_FIELD_NUMBER: _ClassVar[int]
...
class GenerateReportRequest(_message.Message):
    __slots__ = ("type", "title", "team_filter", "gender_filter", "age_group_filter", "columns_on_page", "show_relay_swimmers", "zebra_striping", "renderer_type")
    ...
    def __init__(self, type: _Optional[_Union[ReportType, str]] = ..., title: _Optional[str] = ..., team_filter: _Optional[str] = ..., gender_filter: _Optional[str] = ..., age_group_filter: _Optional[str] = ..., columns_on_page: _Optional[int] = ..., show_relay_swimmers: bool = ..., zebra_striping: bool = ..., renderer_type: _Optional[_Union[RendererType, str]] = ...) -> None: ...
