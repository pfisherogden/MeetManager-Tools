...
def reproduce_issue():
    ...
    # 4. Check for header
    print("CHECKING FOR HEADER IN HTML...")
    if '<div id="header">' in html:
        print("FOUND #header div!")
        # Print a snippet of the header
        idx = html.find('<div id="header">')
        print(html[idx:idx+500])
    else:
        print("MISSING #header div!")
