...
def test_mdb_restorer_compatibility(mock_cp, mock_jvm, tmp_path):
    ...
    with patch("mm_to_json.mdb_writer.jpype") as mock_jpype:
        ...
        mock_db_builder = mock_jpype.JClass("com.healthmarketscience.jackcess.DatabaseBuilder")
        mock_table_builder = mock_jpype.JClass("com.healthmarketscience.jackcess.TableBuilder")
