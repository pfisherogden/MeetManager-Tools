...
class TestReportUseCases(unittest.TestCase):
    def setUp(self):
        ...
        self.table_data = {
            ...
            "Event": [
                {
                    ...
                    "Event_dist": 25, "Event_stroke": "A", "Low_age": 0, "High_age": 0, "Num_finlanes": 6, "Event_rounds": 1
                },
                {
                    "Event_no": 2, "Event_ptr": 2, "Ind_rel": "I", "Event_gender": "M", "Event_sex": "Boys",
                    "Event_dist": 50, "Event_stroke": "A", "Low_age": 15, "High_age": 16, "Num_finlanes": 6, "Event_rounds": 1
                },
                {
            ...
            "Entry": [
                {"Event_ptr": 1, "Ath_no": 1, "Fin_heat": 1, "Fin_lane": 1, "ConvSeed_time": 20.5, "Fin_Time": 0.0, "Fin_Stat": ""},
                {"Event_ptr": 2, "Ath_no": 2, "Fin_heat": 1, "Fin_lane": 1, "ConvSeed_time": 40.0, "Fin_Time": 0.0, "Fin_Stat": ""},
            ],
            "Relay": [
